    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(39 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    Choice::register_dynamic_list("surface_wall_override_filament", &dynamic_filament_list);
...
Plater::priv::priv(Plater *q, MainFrame *main_frame)
    ...
    , config(Slic3r::DynamicPrintConfig::new_from_defaults_keys({
        ...
        "wall_loops", "wall_filament", "surface_wall_override_filament", "outer_wall_count", "sparse_infill_density", "sparse_infill_filament", "top_shell_layers",
...
void Plater::on_config_change(const DynamicPrintConfig &config)
{
    ...
    for (auto opt_key : diff_keys) {
        ...
        // Orca: update when *_filament changed
                 ...
                 opt_key == "surface_wall_override_filament" || opt_key == "outer_wall_count" ||
