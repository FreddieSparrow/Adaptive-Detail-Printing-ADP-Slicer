...
wxBoxSizer *PreferencesDialog::create_item_network_plugin_version_combobox(wxString title, wxString tooltip)
{
    wxBoxSizer *m_sizer_combo = new wxBoxSizer(wxHORIZONTAL);
    m_sizer_combo->AddSpacer(FromDIP(DESIGN_LEFT_MARGIN));

    auto version_title = new wxStaticText(m_parent, wxID_ANY, title, wxDefaultPosition, DESIGN_TITLE_SIZE, wxST_NO_AUTORESIZE);
    version_title->SetForegroundColour(DESIGN_GRAY900_COLOR);
    version_title->SetFont(::Label::Body_14);
    version_title->SetToolTip(tooltip);
    ...
    m_sizer_combo->Add(m_network_version_combo, 0, wxALIGN_CENTER | wxLEFT, FromDIP(5));
